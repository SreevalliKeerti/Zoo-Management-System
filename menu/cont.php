...
<form name="ZOO"method="post">
    <h1 class="text-light" style="font-size: 50px">Update the contact</h1>
   ...
   <input class="form-control" type="number" style="font-size: 25px"name="Zid" placeholder="Zoo ID"> 
    ...
    <input class="form-control" type="text" style="font-size: 25px"name="Contact" placeholder="Contact"> 

   <input class="btn btn-success mt-2" type = 'submit' name='submit' value='Update' style="font-size: 25px" formaction="cont.php"/><br/>
